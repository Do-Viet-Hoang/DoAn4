                        ...
                        <div class="card-body">
                            ...
                            <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    ...
                                    <form action="{{route('admin.nhacungcap-add')}}" method="Post">
                                ...
                                <div class="col-sm-12"><table id="add-row" class="display table table-striped table-hover dataTable" role="grid" aria-describedby="add-row_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 283px;">Tên nhà cung cấp</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 152px;">Số điện thoại</th>
...
@section('script')
    <script>
        ...
        $("[data-role=edit]").click(function() {
            ...
            $.get('{{route('admin.nhacungcap-data')}}', { id: id }, function(data){
                $('#id').val(data.id);
                $('#name').val(data.name);
        ...
        $("[data-role=delete]").click(function(){
            let id = $(this).attr('data-id');
            $.get('{{route('admin.nhacungcap-delete')}}', { id: id }, function(data){
                location.reload();
            });
        });
