        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="dark2">
                ...
                <a href="index.html" class="logo">
					<img src="assets/admin/img/logo1.png" alt="navbar brand" class="navbar-brand">
				</a>
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                            ...
                            <ul class="dropdown-menu messages-notif-box animated fadeIn" aria-labelledby="messageDropdown">
                                <li>
                                    <div class="dropdown-title d-flex justify-content-between align-items-center">
                                        Tin nhắn
                                        <a href="#" class="small">Bạn chưa có tin nhắn nào !</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
                                <li>
                                    <div class="dropdown-title">Bạn không có thông báo nào hôm nay</div>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="assets/admin/img/anhDaiDien.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>
                        </li>
                    </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="tables">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="{{route('admin.hdb')}}">
                                            <span class="sub-item">Hoá đơn bán</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
